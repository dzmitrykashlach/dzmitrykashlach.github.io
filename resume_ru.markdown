...
#### __Кратко обо мне__
- Разработка и рефакторинг Spring Boot приложений (гексогональная архитектура, REST API, Apache Thrift & Kafka, Kotlin/Java 17).
- Поиск проблем с производительностью в высоко-нагруженном монолитном приложении (Spring MVC).
- Разработка CI/CD скриптов для деплоя (Jenkins, TeamCity).
- Разработка несложного UI на Angular 14 (3-4 вкладки, CRUD).
- Опыт работы по Scrum (LeSS) и Kanban.

#### __Проекты__
#### `Sep, 2022 - Apr, 2024` Старший Kotlin разработчик, [Jay.Devs](https://jaydevs.com/)
...
#### __Образование__
`2001-2006` Дизайн электроники, Специалист, [Belarussian State University of Informatics and Radioelectronics(BSUIR)](https://www.bsuir.by/en/)
