...
#### __Кратко обо мне__
- Разработка и рефакторинг серверных приложений (Kotlin 1.8/Java 17, Spring Boot/Ktor, гексогональная архитектура).
- Поиск проблем с производительностью в высоко-нагруженном монолитном приложении (Spring MVC).
- Разработка CI/CD скриптов для деплоя (Jenkins, TeamCity, etc).
- Разработка несложного UI на Angular 14 (3-4 вкладки, CRUD).
- Опыт работы по Scrum (LeSS) и Kanban.

#### __Проекты__
#### `Sep, 2022 - Apr, 2024` Старший Kotlin разработчик, [Altabel Group](https://altabel.com/)
