...
#### __Кратко обо мне__
- Разработка и рефакторинг серверных приложений (Kotlin 2.0/Java 21, Spring Boot, гексогональная архитектура).
...
Стэк: Kotlin 1.8, Spring Boot 3.0, ELK  
Обязанности:
