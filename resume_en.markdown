...
#### __Summary__
- Backend development and refactoring (Kotlin 2.0/Java 21, Spring Boot, hexagonal architecture).
...
- With Infinispan cache ensured that backend is able to handle 200-300 RPS.
...
Environment: Kotlin 2.0, Spring Boot 3.0, ELK  
Responsibilities:
...
| Spring (MVC, Boot, Security, Data, Cloud)   | Advanced     | 4                   |
| Ktor                                        | Intermediate | 1                   |
...
| Cache (Infinispan)                          | Intermediate | 1                   |
