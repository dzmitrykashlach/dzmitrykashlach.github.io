...
#### __Work Experience__
#### `Dec 2024 – Sep 2025`  Senior Kotlin Developer, [Altabel Group](https://altabel.com/)
Product: Gift cards selling application.  
Environment: Kotlin 2.0, Spring Boot 3.0, OAuth 2.0, Keycloak  
Responsibilities:
- Designed and implemented microservices: Kotlin 2.0, Spring Boot 3.0, REST API, MariaDB, Elasticsearch, Loki, Grafana.
